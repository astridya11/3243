    ...
    <body>
      <div class="header">
        <div class="header-left">
          <a href="view/movies_dashboard.php"><img src="../3243/model/image/logo-transparent.png"></a>
        </div>
        <div class="header-right">
          <a href="view/profile.php"><img src="../3243/model/image/profile-icon.png"></a>
        </div>
      </div>
      <div class="container">
        <div class="intro">
          <img src="../3243/model/image/logo-transparent.png">
