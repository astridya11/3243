...
<body>
    <header>
        <div class="container">
            <div class="navbar flex1">
                <nav>
                    <ul id="menuitem">
                        <li><a href="../view/insert_movies.php">Insert New Movie</a></li>
    ...
    <?php if (isset($status)) : ?>
        <p style="color:#008000;"><?php echo htmlspecialchars($status); ?></p>
    <?php endif; ?>
    ...
    <?php else: ?>
        <p style="color:white; margin:10px;">Movie data not found.</p>
    <?php endif; ?>
